...
namespace OguzhanUmutlu\BlockHunt\manager;
...
class ArenaManager {
    ...
    public function createArena(Arena $arena, bool $save = false): bool {
        ...
        if($save) {
            ...
            BlockHunt::getInstance()->arenaConfig->setNested($arena->getData()->name, $array);
            BlockHunt::getInstance()->arenaConfig->save();
            BlockHunt::getInstance()->arenaConfig->reload();
